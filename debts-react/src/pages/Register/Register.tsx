...
const Register = () => {
    ...
    const MudarNome = (e: ChangeEvent<HTMLInputElement>) => setNome(e.target.value)
    const MudarSobrenome = (e: ChangeEvent<HTMLInputElement>) => setSobrenome(e.target.value)
    ...
    const MudarConfirmSenha = (e: ChangeEvent<HTMLInputElement>) => setConfirmSenha(e.target.value)
